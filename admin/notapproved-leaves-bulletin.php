...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | bulletin En cours  </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"> Historique des bulletins en cours</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Historique des bulletins en cours</span>
