...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Totale bulletin de salaire</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">histoire bulletin de salaire</div>
                    </div>
                            ...
                            <div class="card-content">
                               <!-- <span class="card-title">histoire de congé</span>-->
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblbulletin.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblbulletin.PostingDate,tblbulletin.Status from tblbulletin join tblemployees on tblbulletin.empid=tblemployees.id order by lid desc";
