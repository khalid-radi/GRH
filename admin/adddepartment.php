...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Ajouter une Départment</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Ajouter une Départment</div>
                    </div>
