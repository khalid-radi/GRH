...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | attestation En cours  </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"> Historique des attestations en cours</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Historique des attestaions en cours</span>
                                <?php if($msg){?><div class="succWrap"><strong style="color:green;">SUCCÈS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th width="200">Nome Fonctionnaire</th>
...
if($stats==1){
 ...
 <?php } ?>
          ...
          <td>
           <td><a href="attestation-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  > Voir Details</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
