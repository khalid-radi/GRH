...
if($lastInsertId)
{
$msg="Fonctionnaire ajouté avec succès";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Ajouter un Fonctionnaire</title>
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Ajouter un Fonctinnaire</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="addemp">
                                    <div>
                                        <h5>Informations sur les Fonctinnaire</h5>
                                        <section>
...
<div class="input-field col s12">
<label for="confirm">Confirmé mot de passe</label>
...
<input id="birthdate" name="dob" type="date"  autocomplete="off" ><!--class="datepicker"-->
</div>
