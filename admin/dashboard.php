                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title"><a href="manageemployee.php">Total fonctionnaires inscrits</a></span>
...
?>
                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title"><a href="managedepartments.php">Départements répertoriés</a></span>
    <?php
                            ...
                            <div class="card invoices-card">
                             ...
                             <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th width="200">Nom Fonctionnaire</th>
...
if($stats==1){
 ...
 <?php } ?>
          ...
          <td>
           <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  > Détails</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
