...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Totale des attestations</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">histoire des attestation de travail</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                               <!-- <span class="card-title">histoire de congé</span>-->
                                <?php if($msg){?><div class="succWrap"><strong style="color:green;">SUCCÈS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th width="200">Nome de fonctionnaire</th>
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblattestation.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblattestation.PostingDate,tblattestation.Status from tblattestation join tblemployees on tblattestation.empid=tblemployees.id order by lid desc";
