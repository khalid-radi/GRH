...
$query->execute();
$msg="Fonctionnaire mis à jour avec succès";
}
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Mettre à jour le fonctionnaire</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Mettre à jour le fonctionnaire</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                        <h4>Mettre à jour les infos fonctionnaire</h4>
...
<label for="empcode">Matricule de Fonctionnaire (doit être unique)</label>
...
<option value="Marié">M</option>
<option value="célibataire">C</option>
<option value="Divorcé">D</option>
<option value="Veuve">V</option>
</select>
</div>
