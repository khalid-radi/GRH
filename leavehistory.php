...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Historique de congé</title>
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Historique de congé</span>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>à</th>
                                             <th>Description</th>
                                             <th width="120">Date d'affichage</th>
...
{               ?>  
                                        <tr>
                                           ...
                                           <td><?php echo htmlentities($result->Description);?></td>
                                            ...
                                            {
echo htmlentities('Traitement en cours...');
                                            } else
{

 echo htmlentities(($result->AdminRemark)." "."à"." ".$result->AdminRemarkDate);
}
