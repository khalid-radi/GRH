...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Mettre à jour vos informations</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h5>Mettre à jour vos informations</h5></div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                           <?php if($error){?><div class="errorWrap"><strong style="color:red;">ERREUR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
                else if($msg){?><div class="succWrap"><strong style="color:green;">SUCCÈS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                <p><b style="color: red;text-decoration:underline;">*Remarque: </b>Vous ne pouvez pas modifier ce champ.</p>
                                        <section>
...
<label for="empcode">*Matricule de Fonctionnaire</label>
...
<input  name="email" type="text" id="email" value="<?php echo htmlentities($result->EmailId);?>" readonly autocomplete="off" required>
...
<input id="birthdate" name="dob" type="date" value="<?php echo htmlentities($result->Dob);?>" ><!-- class="datepicker"--> 
</div>
...
<div class="input-field col m6 s12">
<label for="city">*N°DEC</label>
<input id="city" name="city" type="text"  value="<?php echo htmlentities($result->City);?>" readonly autocomplete="off" required>
 </div>
